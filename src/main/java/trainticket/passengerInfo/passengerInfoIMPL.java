	...
	public int addPassenger(passengerInfo p1) throws Exception{
		 ...
		 PreparedStatement pst = con.prepareStatement(sql);
		   ...
		   ResultSet rows = stmt.executeQuery(sql1);
		    ...
		    String sql2 = "update seat_availabilities set no_of_seats_available = no_of_seats_available- "+p1.noOfTickets+" where train_num = ?";
		 ...
		 Statement stmt1 = con.createStatement();
		    String sql22 = "insert into payment_status(train_num,user_id,booking_id,tot_ticket_price)values("+p1.trainNum+","+p1.userId+","+bookingId+","+ticket+")";
